...
int main()
{
    ...
    cout << "Sum of all nodes: " << sum_all_nodes(root) << endl;
    cout << "Sum of leaf nodes: " << sum_leaf_nodes(root) << endl;
    cout << "Sum of all nodes except leaf nodes: " << sum_without_leaf_nodes(root) << endl;
    return 0;
}

// input: 10 20 30 40 50 -1 60 -1 -1 -1 -1 -1 -1
// level order: 10 20 30 40 50 60
// sum of all nodes: 210
// sum of leaf nodes: 150
// sum of all nodes except leaf nodes: 60